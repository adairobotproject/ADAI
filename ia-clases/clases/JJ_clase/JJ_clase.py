...
JJ
Materia: IoMT
Generado por ADAI Class Builder el 2025-10-03 15:42:03
...
def main():
    ...
    try:
        ...
        speak_with_animation(engine, f"Hola, soy ADAI. Bienvenidos a la clase: JJ")
        ...
        if class_pdf and os.path.exists(class_pdf):
            ...
            print(f"⚠️ No se encontró PDF: C:/Users/josue/Downloads/Dashboard 88.pdf")
        ...
        # Finalización
        speak_with_animation(engine, f"Gracias por participar en la clase: JJ. ¡Hasta la próxima!")
