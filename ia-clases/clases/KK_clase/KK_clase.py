...
Generado por ADAI Class Builder el 2025-10-03 14:55:32
...
def main():
    ...
    try:
        print("🚀 Iniciando clase: KK")
        print("📚 Materia: Exoesqueletos")
        ...
        speak_with_animation(engine, f"Hola, soy ADAI. Bienvenidos a la clase: KK")
        speak_with_animation(engine, f"Vamos a aprender sobre Exoesqueletos")
        ...
        if class_pdf and os.path.exists(class_pdf):
            speak_with_animation(engine, f"Ahora comenzaremos con la presentación sobre Exoesqueletos.")
        ...
        # Finalización
        speak_with_animation(engine, f"Gracias por participar en la clase: KK. ¡Hasta la próxima!")
