...
Generado por ADAI Class Builder el 2025-10-03 14:44:45
...
def main():
    ...
    try:
        ...
        speak_with_animation(engine, f"Hola, soy ADAI. Bienvenidos a la clase: awdawd")
        ...
        # Finalización
        speak_with_animation(engine, f"Gracias por participar en la clase: awdawd. ¡Hasta la próxima!")
